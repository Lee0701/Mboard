...
import ee.oyatl.ime.f.module.component.KeyboardComponent
import ee.oyatl.ime.f.module.inputengine.CodeConverterInputEngine
import ee.oyatl.ime.f.module.inputengine.HangulInputEngine
import ee.oyatl.ime.f.module.inputengine.InputEngine
import ee.oyatl.ime.f.preset.softkeyboard.Include
import ee.oyatl.ime.f.preset.softkeyboard.Keyboard
import ee.oyatl.ime.f.preset.softkeyboard.Row
import ee.oyatl.ime.f.preset.softkeyboard.RowItem
...
import ee.oyatl.ime.f.preset.table.SimpleCodeConvertTable
