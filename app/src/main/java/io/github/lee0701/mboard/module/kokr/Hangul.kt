...
object Hangul {
    val CONVERT_CHO = intArrayOf(0x1100,0x1101,0x0000,0x1102,0x0000,0x115d,0x1103,  // 0x3130 (0x115d: traditional)
    ...
    val CONVERT_OLDHANGUL_JUNG = intArrayOf(
